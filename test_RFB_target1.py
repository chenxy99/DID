...
parser.add_argument('-m', '--trained_model', default='weights/task1-target1/test-exp-nopretrain/Final_RFB_vgg_VOC.pth',
...
def test_net(save_folder, net, detector, cuda, testset, transform, max_per_image=300, thresh=0.005):
    ...
    for i in range(num_images):
        ...
        _, target = testset.__getitem__(i)
        with torch.no_grad():
