...
class MultiBoxLoss_tf_source_combine(nn.Module):
    ...
    def __init__(self, num_classes,overlap_thresh,prior_for_matching,bkg_label,neg_mining,neg_pos,neg_overlap,encode_target):
        super(MultiBoxLoss_tf_source_combine, self).__init__()
    ...
    def forward(self, predictions, priors, targets):
        ...
        #P_0 = torch.log(torch.exp(batch_bin_conf[:, 0]).unsqueeze(1) * log_sum_exp(batch_conf) +
        ...
        loss_l/=N
        loss_cls/=N
        return loss_l, loss_cls, pos, neg
