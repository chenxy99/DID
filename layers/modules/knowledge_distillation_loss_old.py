...
class KD_loss(nn.Module):
    ...
    def forward(self, source_out, target1_out, target1_out1, priors, targets, pos, neg):
        ...
        neg_idx = neg.unsqueeze(neg.dim()).expand_as(P_logit)
        ...
        batch_conf_target = conf_data_target.view(-1, self.num_classes)
        ...
        neg_idx = neg.unsqueeze(neg.dim()).expand_as(P_logit_target)
