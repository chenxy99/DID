...
parser.add_argument('-m', '--trained_model', default='weights/task1-target2/test-exp-nopretrain/Final_RFB_vgg_VOC.pth',
...
def test_net(save_folder, net, detector, cuda, testset, transform, max_per_image=300, thresh=0.005):
    ...
    for i in range(num_images):
        ...
        _t['im_detect'].tic()
        out, out1, out2, _ = net(x)      # forward pass
...
if __name__ == '__main__':
    ...
    net = build_net('test', img_dim, num_classes, num_classes_target1, num_classes_target2)    # initialize detector
