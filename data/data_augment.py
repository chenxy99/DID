...
class preproc_tf(object):
    ...
    def __call__(self, image, targets):
        ...
        height, width, _ = image_t.shape
        image_t_resnet = preproc_for_test(image_t, 224, self.means)
        image_t = preproc_for_test(image_t, self.resize, self.means)
        boxes = boxes.copy()
        boxes[:, 0::2] /= width
        boxes[:, 1::2] /= height
        ...
        return torch.from_numpy(image_t), targets_t, torch.from_numpy(image_t_resnet)
