...
class RFBNet(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes, num_classes_target1, num_classes_target2):
    ...
    def forward(self, x):
        ...
        return output, output_target1, output_target2, embedding_target2_output
...
def multibox(size, vgg, extra_layers, cfg, num_classes, num_classes_target1, num_classes_target2):
    # for the source
    loc_layers = []
    conf_layers = []
    bin_conf_layers = []
...
def build_net(phase, size=300, num_classes=21, num_classes_target1 = 21, num_classes_target2=6):
    ...
    return RFBNet(phase, size, *multibox(size, vgg(base[str(size)], 3),
                                ...
                                mbox[str(size)], num_classes, num_classes_target1,num_classes_target2), num_classes, num_classes_target1, num_classes_target2)
